![Hu Group](https://github.com/USTC-Hu-Group/.github/blob/main/images/Hu.png)
...
- Electronic structure of complex and strongly correlated systems
...
- **KSSOLV**  
  A MATLAB-based research platform for developing and testing numerical algorithms for
  Kohn–Sham density functional theory, with a focus on iterative solvers, eigensolvers,
  and algorithmic prototyping.

- **PWDFT**  
  A plane-wave density functional theory package emphasizing algorithmic clarity and
  high-performance implementations for large-scale electronic structure calculations.

- **DGDFT**  
  A discontinuous Galerkin density functional theory framework designed for
  massively parallel, large-scale simulations of complex materials systems on modern
...
High-Performance Intelligent Quantum Computational Chemistry Laboratory
